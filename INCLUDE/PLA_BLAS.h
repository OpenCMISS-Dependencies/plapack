 ...
 */
  ...
  #define            PLA_sgemv(           trans,       m, n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(sgemv,SGEMV) (       trans,       m, n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_ssymv(     uplo,                 n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(ssymv,SSYMV) ( uplo,                 n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_strmv(     uplo, trans, diag,    n,        a, lda, x, incx ) \
          PLA_FOR2C(strmv,STRMV) ( uplo, trans, diag,    n,        a, lda, x, incx )
  #define            PLA_strsv(     uplo, trans, diag,    n,        a, lda, x, incx ) \
          PLA_FOR2C(strsv,STRSV) ( uplo, trans, diag,    n,        a, lda, x, incx )
  ...
  #define           PLA_ssyr(      uplo,    n, alpha, x, incx,          a, lda ) \
          PLA_FOR2C(ssyr,SSYR) ( uplo,    n, alpha, x, incx,          a, lda )
  #define           PLA_ssyr2(     uplo,    n, alpha, x, incx, y, incy, a, lda ) \
          PLA_FOR2C(ssyr2,SSYR2) ( uplo,    n, alpha, x, incx, y, incy, a, lda )
  ...
  #define            PLA_dgemv(           trans,       m, n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(dgemv,DGEMV) (       trans,       m, n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_dsymv(     uplo,                 n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(dsymv,DSYMV) ( uplo,                 n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_dtrmv(     uplo, trans, diag,    n,        a, lda, x, incx ) \
          PLA_FOR2C(dtrmv,DTRMV) ( uplo, trans, diag,    n,        a, lda, x, incx )
  #define            PLA_dtrsv(     uplo, trans, diag,    n,        a, lda, x, incx ) \
          PLA_FOR2C(dtrsv,DTRSV) ( uplo, trans, diag,    n,        a, lda, x, incx )
  ...
  #define           PLA_dsyr(      uplo,    n, alpha, x, incx,          a, lda ) \
          PLA_FOR2C(dsyr,DSYR) ( uplo,    n, alpha, x, incx,          a, lda )
  #define           PLA_dsyr2(     uplo,    n, alpha, x, incx, y, incy, a, lda ) \
          PLA_FOR2C(dsyr2,DSYR2) ( uplo,    n, alpha, x, incx, y, incy, a, lda )
  ...
  #define            PLA_cgemv(           trans,       m, n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(cgemv,CGEMV) (       trans,       m, n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_csymv(     uplo,                 n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(csymv,CSYMV) ( uplo,                 n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_chemv(     uplo,                 n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(chemv,CHEMV) ( uplo,                 n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_ctrmv(     uplo, trans, diag,    n,        a, lda, x, incx ) \
          PLA_FOR2C(ctrmv,CTRMV) ( uplo, trans, diag,    n,        a, lda, x, incx )
  #define            PLA_ctrsv(     uplo, trans, diag,    n,        a, lda, x, incx ) \
          PLA_FOR2C(ctrsv,CTRSV) ( uplo, trans, diag,    n,        a, lda, x, incx )
  ...
  #define           PLA_cher(      uplo,    n, alpha, x, incx,          a, lda ) \
          PLA_FOR2C(cher,CHER) ( uplo,    n, alpha, x, incx,          a, lda )
  #define           PLA_cher2(     uplo,    n, alpha, x, incx, y, incy, a, lda ) \
          PLA_FOR2C(cher2,CHER2) ( uplo,    n, alpha, x, incx, y, incy, a, lda )

  /*
   * Double precision complex
   */
  #define            PLA_zgemv(           trans,       m, n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(zgemv,ZGEMV) (       trans,       m, n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_zsymv(     uplo,                 n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(zsymv,ZSYMV) ( uplo,                 n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_zhemv(     uplo,                 n, alpha, a, lda, x, incx, beta, y, incy ) \
          PLA_FOR2C(zhemv,ZHEMV) ( uplo,                 n, alpha, a, lda, x, incx, beta, y, incy )
  #define            PLA_ztrmv(     uplo, trans, diag,    n,        a, lda, x, incx ) \
          PLA_FOR2C(ztrmv,ZTRMV) ( uplo, trans, diag,    n,        a, lda, x, incx )
  #define            PLA_ztrsv(     uplo, trans, diag,    n,        a, lda, x, incx ) \
          PLA_FOR2C(ztrsv,ZTRSV) ( uplo, trans, diag,    n,        a, lda, x, incx )
  ...
  #define           PLA_zher(      uplo,    n, alpha, x, incx,          a, lda ) \
          PLA_FOR2C(zher,ZHER) ( uplo,    n, alpha, x, incx,          a, lda )
  #define           PLA_zher2(     uplo,    n, alpha, x, incx, y, incy, a, lda ) \
          PLA_FOR2C(zher2,ZHER2) ( uplo,    n, alpha, x, incx, y, incy, a, lda )
 ...
 */
  ...
  #define           PLA_sgemm( transa, transb,  m, n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(sgemm,SGEMM) (   transa, transb,       m, n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_ssymm(     side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(ssymm,SSYMM) ( side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_ssyrk(           uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )  \
          PLA_FOR2C(ssyrk,SSYRK) (       uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )
  #define           PLA_ssyr2k(          uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(ssyr2k,SSYR2K) (       uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_strmm(     side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )  \
          PLA_FOR2C(strmm,STRMM) ( side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )
  #define           PLA_strsm(     side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )  \
          PLA_FOR2C(strsm,STRSM) ( side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )
  ...
  #define           PLA_dgemm(                 transa, transb,       m, n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(dgemm,DGEMM) (             transa, transb,       m, n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_dsymm(     side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(dsymm,DSYMM) ( side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_dsyrk(           uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )  \
          PLA_FOR2C(dsyrk,DSYRK) (       uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )
  #define           PLA_dsyr2k(          uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(dsyr2k,DSYR2K) (       uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_dtrmm(     side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )  \
          PLA_FOR2C(dtrmm,DTRMM) ( side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )
  #define           PLA_dtrsm(     side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )  \
          PLA_FOR2C(dtrsm,DTRSM) ( side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )
  ...
  #define           PLA_cgemm(                 transa, transb,       m, n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(cgemm,CGEMM) (             transa, transb,       m, n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_csymm(     side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(csymm,CSYMM) ( side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_chemm(     side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(chemm,CHEMM) ( side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_csyrk(           uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )  \
          PLA_FOR2C(csyrk,CSYRK) (       uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )
  #define           PLA_cherk(           uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )  \
          PLA_FOR2C(cherk,CHERK) (       uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )
  #define           PLA_csyr2k(          uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(csyr2k,CSYR2K) (       uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_cher2k(          uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(cher2k,CHER2K) (       uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_ctrmm(     side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )  \
          PLA_FOR2C(ctrmm,CTRMM) ( side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )
  #define           PLA_ctrsm(     side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )  \
          PLA_FOR2C(ctrsm,CTRSM) ( side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )

  /*
   * Double precision complex
   */
  #define           PLA_zgemm(                 transa, transb,       m, n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(zgemm,ZGEMM) (             transa, transb,       m, n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_zsymm(     side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(zsymm,ZSYMM) ( side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_zhemm(     side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(zhemm,ZHEMM) ( side, uplo,                       m, n,    alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_zsyrk(           uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )  \
          PLA_FOR2C(zsyrk,ZSYRK) (       uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )
  #define           PLA_zherk(           uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )  \
          PLA_FOR2C(zherk,ZHERK) (       uplo, trans,                   n, k, alpha, a, lda,         beta, c, ldc )
  #define           PLA_zsyr2k(          uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(zsyr2k,ZSYR2K) (       uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_zher2k(          uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )  \
          PLA_FOR2C(zher2k,ZHER2K) (       uplo, trans,                   n, k, alpha, a, lda, b, ldb, beta, c, ldc )
  #define           PLA_ztrmm(     side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )  \
          PLA_FOR2C(ztrmm,ZTRMM) ( side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )
  #define           PLA_ztrsm(     side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )  \
          PLA_FOR2C(ztrsm,ZTRSM) ( side, uplo, transa,         diag, m, n,    alpha, a, lda, b, ldb               )
...
#define PLA_dsteqr( compz, n, d, e, z, ldz, work, info ) \
          PLA_FOR2C(dsteqr,DSTEQR) ( compz, n, d, e, z, ldz, work, info )
#else
#define PLA_dsteqr( compz, n, d, e, z, ldz, work, info ) \
...
#define PLA_dsteqr_x( compz, m, n, d, e, z, ldz, work, info ) \
          PLA_FOR2C(dsteqr_x,DSTEQR_X)( compz, m, n, d, e, z, ldz, work, info )
...
#define PLA_spotrf( uplo, n, a, lda, info ) \
          PLA_FOR2C(spotrf,SPOTRF) (   uplo, n, a, lda, info )

#define PLA_dpotrf( uplo, n, a, lda, info ) \
          PLA_FOR2C(dpotrf,DPOTRF) (   uplo, n, a, lda, info )

#define PLA_cpotrf( uplo, n, a, lda, info ) \
          PLA_FOR2C(cpotrf,CPOTRF) (   uplo, n, a, lda, info )

#define PLA_zpotrf( uplo, n, a, lda, info ) \
          PLA_FOR2C(zpotrf,ZPOTRF) (   uplo, n, a, lda, info )
#else
#define PLA_dsteqr_x( compz, m, n, d, e, z, ldz, work, info ) \
...
#define PLA_dbdsqr_x( uplo, n, nv, nru, ncc, d, e, v, ldv, \
		      u, ldu, c, ldc, work, info ) \
          dbdsqr_x_( uplo, n, nv, nru, ncc, d, e, v, ldv, \
		      u, ldu, c, ldc, work, info ) 

/* LAPACK Cholesky factorization */
#define PLA_spotrf( uplo, n, a, lda, info ) \
          PLA_FOR2C(spotrf_,SPOTRF_)(   uplo, n, a, lda, info )

#define PLA_dpotrf( uplo, n, a, lda, info ) \
          PLA_FOR2C(dpotrf_,DPOTRF_)(   uplo, n, a, lda, info )

#define PLA_cpotrf( uplo, n, a, lda, info ) \
          PLA_FOR2C(cpotrf_,CPOTRF_)(   uplo, n, a, lda, info )

#define PLA_zpotrf( uplo, n, a, lda, info ) \
          PLA_FOR2C(zpotrf_,ZPOTRF_)(   uplo, n, a, lda, info )
#endif
#else
#define PLA_dsteqr_x( compz, m, n, d, e, z, ldz, work, info ) \
...
#define PLA_dbdsqr_x( uplo, n, nv, nru, ncc, d, e, v, ldv, \
		      u, ldu, c, ldc, work, info ) \
          SBDSQR_X(   PLA_CP2FCD( uplo ),  n, nv, nru, ncc, d, e, v, ldv, \
		      u, ldu, c, ldc, work, info ) 
