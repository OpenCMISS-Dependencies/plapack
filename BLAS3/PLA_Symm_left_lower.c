...
int PLA_Symm_left_lower ( PLA_Obj alpha, PLA_Obj A, PLA_Obj B, PLA_Obj C,
                          int nb_alg )
{
  PLA_Obj     ATL=NULL, ATR=NULL,     A00=NULL, A01=NULL, A02=NULL,  BT=NULL,  B0=NULL,  CT=NULL,  C0=NULL,
             ...
             ONE=NULL, 
             B1_dpmv=NULL, C1_dpmv=NULL, A10_dpmv=NULL, A21_dpmv=NULL, A11_dmsc=NULL;
  int         b;
  ...
  while ( b = min( PLA_Obj_length( ABR ), nb_alg ) ){
    ...
    PLA_Local_gemm( PLA_NO_TRANSPOSE, PLA_NO_TRANSPOSE, 
		    alpha, A10_dpmv, B1_dpmv, ONE, C0 );

    PLA_Local_gemm( PLA_NO_TRANSPOSE, PLA_NO_TRANSPOSE, 
		    alpha, A21_dpmv, B1_dpmv, ONE, C2 );

    PLA_Local_symm( PLA_SIDE_LEFT, PLA_LOWER_TRIANGULAR,
